...
@Autonomous(name = "Camera Blue Close", group = "Camera")
//@Disabled
public class Camera_Blue_Close extends LinearOpMode {
    DcMotor fl_Wheel;
    DcMotor bl_Wheel;
    DcMotor fr_Wheel;
    DcMotor br_Wheel;
    ...
    private static final String TFOD_MODEL_ASSET = "BluePenguinB.tflite";
    // TFOD_MODEL_FILE points to a model file stored onboard the Robot Controller's storage,
    // this is used when uploading models directly to the RC using the model upload interface.
    private static final String TFOD_MODEL_FILE = "/sdcard/FIRST/tflitemodels/BluePenguinB.tflite";
